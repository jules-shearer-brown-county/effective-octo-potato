#!/bin/env python3
#process_apps_team.py - chops up a vuln export based on host_id.custom_tags
...
def process_apps_team(input_file=utility.get_latest_scan_from_downloads()):
    vulnerabilites = utility.read_data(input_file)
    return vulnerabilites

if __name__ ==  '__main__':
    open_vuln = process_apps_team()
